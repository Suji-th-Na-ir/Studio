...
namespace GLTFast.Materials {
    ...
    public class ShaderGraphMaterialGenerator : MaterialGenerator {
        ...
        const string k_ShaderPathPrefix = "Assets/Plugins/" + GltfGlobals.GltfPackageName + "/Runtime/Shader/";
#else
        const string k_ShaderPathPrefix = "Assets/Plugins/" + GltfGlobals.GltfPackageName + "/Runtime/Shader/Legacy/";
#endif
#else
